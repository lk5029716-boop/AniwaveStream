    ...
    Box(Modifier.fillMaxSize().background(Color.Black)) {
        ...
        AnimatedVisibility(
            ...
            Row(
                ...
                // clip on narrow landscape screens ("action tabs failed" symptom).
                ...
                // SUB / DUB chooser (Dantotsu-style). Tapping switches the stream
                // type and re-resolves against the backend (?type=sub|dub).
                Box(
                    Modifier
                        .background(
